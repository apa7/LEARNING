...
class Solution {
    public double findMedianSortedArrays1(int[] nums1, int[] nums2) {
        ...
        BigDecimal num1 = len1 % 2 == 1 ? BigDecimal.valueOf(nums1[len1 / 2]) : div2(nums1[len1 / 2 - 1] + nums1[len1 / 2]);
        BigDecimal num2 = len2 % 2 == 1 ? BigDecimal.valueOf(nums2[len2 / 2]) : div2(nums2[len2 / 2 - 1] + nums2[len2 / 2]);
        return num1.add(num2).divide(BigDecimal.valueOf(2)).doubleValue();
    }
    ...
    public BigDecimal div2(int num) {
        return BigDecimal.valueOf(num).divide(BigDecimal.valueOf(2));
    }

    public static void main(String[] args) {
        int[] nums1 = new int[]{1, 3};
        int[] nums2 = new int[]{2};
        double v = new Solution().findMedianSortedArrays(nums1, nums2);
